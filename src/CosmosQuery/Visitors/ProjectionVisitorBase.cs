...
internal abstract class ProjectionVisitorBase : ExpressionVisitor
{
    private int currentIndex;
    protected readonly List<PathSegment> pathSegments;
    protected readonly ODataQueryContext context;

    protected ProjectionVisitorBase(List<PathSegment> pathSegments, ODataQueryContext context)
    {
        this.currentIndex = 0;

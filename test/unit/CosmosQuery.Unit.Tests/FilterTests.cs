...
namespace ExpressionBuilder.Tests
{
    public class FilterTests
    {
        ...
        public void EnumInExpression()
        {
            ...
            //assert
            AssertFilterStringIsCorrect(filter, "it => System.Collections.Generic.List`1[CosmosQuery.Unit.Tests.Data.SimpleEnum].Contains(it.SimpleEnumProp)");
        ...
        public void EnumInExpression_WithNullValue_Throws()
        {
            ...
            Assert.Equal
            (
                "A null value was found with the expected type 'CosmosQuery.Unit.Tests.Data.SimpleEnum[Nullable=False]'. The expected type 'CosmosQuery.Unit.Tests.Data.SimpleEnum[Nullable=False]' does not allow null values.",
                exception.Message
            );
        }
        ...
        public void EnumInExpression_NullableEnum_WithNullable()
        {
            ...
            //assert
            AssertFilterStringIsCorrect(filter, "it => System.Collections.Generic.List`1[System.Nullable`1[CosmosQuery.Unit.Tests.Data.SimpleEnum]].Contains(it.NullableSimpleEnumProp)");
        ...
        {
            //act
            var filter = GetFilter<Product>("Category/EnumerableProducts/CosmosQuery.Unit.Tests.Data.DerivedProduct/any(p: p/ProductName eq 'ProductName')");
        ...
        {
            //act
            var filter = GetFilter<Product>("Category/QueryableProducts/CosmosQuery.Unit.Tests.Data.DerivedProduct/any(p: p/ProductName eq 'ProductName')");
        ...
        {
            //act
            var filter = GetFilter<Product>("Category/Products/CosmosQuery.Unit.Tests.Data.DerivedProduct/any(p: p/DerivedProductName eq 'DerivedProductName')");
        ...
        {
            //act
            var filter = GetFilter<DerivedProduct>("CosmosQuery.Unit.Tests.Data.Product/ProductName eq 'ProductName'");
        ...
        [Theory]
        [InlineData("CosmosQuery.Unit.Tests.Data.Product/ProductName eq 'ProductName'")]
        [InlineData("CosmosQuery.Unit.Tests.Data.DerivedProduct/DerivedProductName eq 'DerivedProductName'")]
        [InlineData("CosmosQuery.Unit.Tests.Data.DerivedProduct/Category/CategoryID eq 123")]
        [InlineData("CosmosQuery.Unit.Tests.Data.DerivedProduct/Category/CosmosQuery.Unit.Tests.Data.DerivedCategory/CategoryID eq 123")]
        ...
        [Theory]
        [InlineData("CosmosQuery.Unit.Tests.Data.DerivedProduct/DerivedProductName eq 'ProductName'")]
        [InlineData("CosmosQuery.Unit.Tests.Data.DerivedProduct/Category/CategoryID eq 123")]
        [InlineData("CosmosQuery.Unit.Tests.Data.DerivedProduct/Category/CosmosQuery.Unit.Tests.Data.DerivedCategory/CategoryID eq 123")]
        ...
        {
            //assert
            var exception = Assert.Throws<ODataException>(() => GetFilter<Product>("CosmosQuery.Unit.Tests.Data.DerivedCategory/CategoryID eq 123"));
            Assert.Equal
            (
                "Encountered invalid type cast. 'CosmosQuery.Unit.Tests.Data.DerivedCategory' is not assignable from 'CosmosQuery.Unit.Tests.Data.Product'.",
                exception.Message
            );
        }
        ...
        [InlineData("cast(null,'CosmosQuery.Unit.Tests.Data.SimpleEnum') eq null", "it => (null == null)")]
        [InlineData("cast(null,'CosmosQuery.Unit.Tests.Data.FlagsEnum') eq null", "it => (null == null)")]
        ...
        [InlineData("cast(CosmosQuery.Unit.Tests.Data.SimpleEnum'1',Edm.String) eq '1'", "it => (Convert(Second).ToString() == \"1\")")]
        [InlineData("cast(cast(cast(IntProp,Edm.Int64),Edm.Int16),Edm.String) eq '123'", "it => (Convert(Convert(it.IntProp)).ToString() == \"123\")")]
        [InlineData("cast('123',CosmosQuery.Unit.Tests.Data.SimpleEnum) ne null", "it => (Convert(123) != null)")]
        ...
        [InlineData("cast(NoSuchProperty,Edm.Int32) ne null",
            "Could not find a property named 'NoSuchProperty' on type 'CosmosQuery.Unit.Tests.Data.DataTypes'.")]
        ...
        [Theory]
        [InlineData("cast(CosmosQuery.Unit.Tests.Data.SimpleEnum) ne null")]
        [InlineData("cast(CosmosQuery.Unit.Tests.Data.FlagsEnum) ne null")]
        [InlineData("cast(0,CosmosQuery.Unit.Tests.Data.SimpleEnum) ne null")]
        [InlineData("cast(0,CosmosQuery.Unit.Tests.Data.FlagsEnum) ne null")]
        [InlineData("cast(CosmosQuery.Unit.Tests.Data.SimpleEnum'0',CosmosQuery.Unit.Tests.Data.SimpleEnum) ne null")]
        [InlineData("cast(CosmosQuery.Unit.Tests.Data.FlagsEnum'0',CosmosQuery.Unit.Tests.Data.FlagsEnum) ne null")]
        [InlineData("cast(SimpleEnumProp,CosmosQuery.Unit.Tests.Data.SimpleEnum) ne null")]
        [InlineData("cast(FlagsEnumProp,CosmosQuery.Unit.Tests.Data.FlagsEnum) ne null")]
        [InlineData("cast(NullableSimpleEnumProp,CosmosQuery.Unit.Tests.Data.SimpleEnum) ne null")]
        [InlineData("cast(IntProp,CosmosQuery.Unit.Tests.Data.SimpleEnum) ne null")]
        [InlineData("cast(DateTimeOffsetProp,CosmosQuery.Unit.Tests.Data.SimpleEnum) ne null")]
        [InlineData("cast(CosmosQuery.Unit.Tests.Data.SimpleEnum'1',Edm.Int32) eq 1")]
        [InlineData("cast(CosmosQuery.Unit.Tests.Data.FlagsEnum'1',Edm.Int32) eq 1")]
        ...
        [InlineData("cast(StringProp,CosmosQuery.Unit.Tests.Data.SimpleEnum) eq null")]
        [InlineData("cast(StringProp,CosmosQuery.Unit.Tests.Data.FlagsEnum) eq null")]
        ...
        [Theory]
        [InlineData("cast(null,CosmosQuery.Unit.Tests.Data.Address) ne null",
            "Encountered invalid type cast. " +
            "'CosmosQuery.Unit.Tests.Data.Address' is not assignable from 'CosmosQuery.Unit.Tests.Data.DataTypes'.")]
        [InlineData("cast(null,CosmosQuery.Unit.Tests.Data.DataTypes) ne null",
        ...
        [InlineData("cast('CosmosQuery.Unit.Tests.Data.DataTypes') eq null")]
        [InlineData("cast($it,'CosmosQuery.Unit.Tests.Data.DataTypes') eq null")]
        ...
        {
            //act
            FilterClause filterClause = ODataHelpers.GetFilterClause<DataTypes>("cast(StringProp,'CosmosQuery.Unit.Tests.Data.SimpleEnum') eq null", serviceProvider);
            ...
            Assert.Equal("CosmosQuery.Unit.Tests.Data.SimpleEnum", ((ConstantNode)castNode.Parameters.Last()).Value);
        }
        ...
        public static List<object[]> CastToUnquotedComplexType
        {
            get
            {
                return new List<object[]>
                {
                    new [] { "cast(CosmosQuery.Unit.Tests.Data.Address) eq null" },
                    new [] { "cast(null, CosmosQuery.Unit.Tests.Data.Address) eq null" },
                    new [] { "cast('', CosmosQuery.Unit.Tests.Data.Address) eq null" },
                    new [] { "cast(SupplierAddress, CosmosQuery.Unit.Tests.Data.Address) eq null" },
                };
            }
        }
        ...
        public void CastToUnquotedComplexType_ThrowsODataException(string filterString)
        {
            ...
            var expectedErrorMessage =
                "Encountered invalid type cast. " +
                "'CosmosQuery.Unit.Tests.Data.Address' is not assignable from 'CosmosQuery.Unit.Tests.Data.Product'.";
        ...
        public static List<object[]> CastToQuotedComplexType
        {
            get
            {
                return new List<object[]>
                {
                    ...
                    new [] { "cast(null, 'CosmosQuery.Unit.Tests.Data.Address') eq null" },
                    new [] { "cast('', 'CosmosQuery.Unit.Tests.Data.Address') eq null" },
                    new [] { "cast(SupplierAddress, 'CosmosQuery.Unit.Tests.Data.Address') ne null" },
                };
            }
        }
        ...
        public static List<object[]> CastToUnquotedEntityType
        {
            get
            {
                ...
                {
                    new [] {
                        "cast(CosmosQuery.Unit.Tests.Data.DerivedProduct)/DerivedProductName eq null",
                        "Cast or IsOf Function must have a type in its arguments."
                    },
                    new [] {
                        "cast(null, CosmosQuery.Unit.Tests.Data.DerivedCategory)/DerivedCategoryName eq null",
                        "Encountered invalid type cast. " +
                        "'CosmosQuery.Unit.Tests.Data.DerivedCategory' is not assignable from 'CosmosQuery.Unit.Tests.Data.Product'."
                    },
                    new [] {
                        "cast(Category, CosmosQuery.Unit.Tests.Data.DerivedCategory)/DerivedCategoryName eq null",
                        "Encountered invalid type cast. " +
                        "'CosmosQuery.Unit.Tests.Data.DerivedCategory' is not assignable from 'CosmosQuery.Unit.Tests.Data.Product'."
                    },
                };
        ...
        [Theory]
        [InlineData("cast('CosmosQuery.Unit.Tests.Data.DerivedProduct')/DerivedProductName eq null", "it => ((it As DerivedProduct).DerivedProductName == null)")]
        [InlineData("cast(Category,'CosmosQuery.Unit.Tests.Data.DerivedCategory')/DerivedCategoryName eq null", "it => ((it.Category As DerivedCategory).DerivedCategoryName == null)")]
        ...
        [InlineData("isof('CosmosQuery.Unit.Tests.Data.Product')", "it => IIF((it Is CosmosQuery.Unit.Tests.Data.Product), True, False)")]
        [InlineData("isof(ProductName,Edm.String)", "it => IIF((it.ProductName Is System.String), True, False)")]
        [InlineData("isof(Category,'CosmosQuery.Unit.Tests.Data.Category')", "it => IIF((it.Category Is CosmosQuery.Unit.Tests.Data.Category), True, False)")]
        [InlineData("isof(Category,'CosmosQuery.Unit.Tests.Data.DerivedCategory')", "it => IIF((it.Category Is CosmosQuery.Unit.Tests.Data.DerivedCategory), True, False)")]
        [InlineData("isof(Ranking, 'CosmosQuery.Unit.Tests.Data.SimpleEnum')", "it => IIF((it.Ranking Is CosmosQuery.Unit.Tests.Data.SimpleEnum), True, False)")]
        ...
        [InlineData("isof(null,CosmosQuery.Unit.Tests.Data.SimpleEnum)")]
        [InlineData("isof(null,CosmosQuery.Unit.Tests.Data.FlagsEnum)")]

        [InlineData("isof(ByteArrayProp,Edm.Binary)")] // ByteArrayProp == null
        [InlineData("isof(IntProp,CosmosQuery.Unit.Tests.Data.SimpleEnum)")]
        ...
        [InlineData("isof('CosmosQuery.Unit.Tests.Data.SimpleEnum')")]
        [InlineData("isof('CosmosQuery.Unit.Tests.Data.FlagsEnum')")]
        ...
        [InlineData("isof(0,'CosmosQuery.Unit.Tests.Data.FlagsEnum')")]
        [InlineData("isof(0,'CosmosQuery.Unit.Tests.Data.SimpleEnum')")]
        ...
        public static List<object[]> IsOfUnquotedComplexType
        {
            get
            {
                return new List<object[]>
                {
                    new [] { "isof(CosmosQuery.Unit.Tests.Data.Address)" },
                    new [] { "isof(null,CosmosQuery.Unit.Tests.Data.Address)" },
                    new [] { "isof(null, CosmosQuery.Unit.Tests.Data.Address)" },
                    new [] { "isof(SupplierAddress,CosmosQuery.Unit.Tests.Data.Address)" },
                    new [] { "isof(SupplierAddress, CosmosQuery.Unit.Tests.Data.Address)" },
                };
            }
        }
        ...
        public static List<object[]> IsOfUnquotedEntityType
        {
            get
            {
                ...
                {
                    new [] {
                        "isof(CosmosQuery.Unit.Tests.Data.DerivedProduct)",
                        "Cast or IsOf Function must have a type in its arguments."
                    },
                    new [] {
                        "isof(null,CosmosQuery.Unit.Tests.Data.DerivedCategory)",
                        "Encountered invalid type cast. " +
                        "'CosmosQuery.Unit.Tests.Data.DerivedCategory' is not assignable from 'CosmosQuery.Unit.Tests.Data.Product'."
                    },
                    new [] {
                    ...
                    new [] {
                        "isof(Category,CosmosQuery.Unit.Tests.Data.DerivedCategory)",
                        "Encountered invalid type cast. " +
                        "'CosmosQuery.Unit.Tests.Data.DerivedCategory' is not assignable from 'CosmosQuery.Unit.Tests.Data.Product'."
                    },
                    new [] {
        ...
        public static List<object[]> IsOfQuotedNonPrimitiveType
        {
            get
            {
                return new List<object[]>
                {
                    new [] { "isof('CosmosQuery.Unit.Tests.Data.DerivedProduct')" },
                    new [] { "isof(SupplierAddress,'CosmosQuery.Unit.Tests.Data.Address')" },
                    new [] { "isof(SupplierAddress, 'CosmosQuery.Unit.Tests.Data.Address')" },
                    new [] { "isof(Category,'CosmosQuery.Unit.Tests.Data.DerivedCategory')" },
                    new [] { "isof(Category, 'CosmosQuery.Unit.Tests.Data.DerivedCategory')" },
                };
            }
        }
        ...
        [Theory]
        [InlineData("isof(null,'CosmosQuery.Unit.Tests.Data.Address')")]
        [InlineData("isof(null, 'CosmosQuery.Unit.Tests.Data.Address')")]
        [InlineData("isof(null,'CosmosQuery.Unit.Tests.Data.DerivedCategory')")]
        [InlineData("isof(null, 'CosmosQuery.Unit.Tests.Data.DerivedCategory')")]
        ...
        [InlineData("SimpleEnumProp eq @p", "CosmosQuery.Unit.Tests.Data.SimpleEnum'First'", "it => (it.SimpleEnumProp == First)")]
        ...
        [InlineData("@p eq CosmosQuery.Unit.Tests.Data.SimpleEnum'First'", "SimpleEnumProp", "it => (it.SimpleEnumProp == First)")]
        ...
        // Used by Custom Method binder tests - by reflection
        private string PadRightStatic(string str, int number)
        {
            return str.PadRight(number);
        }

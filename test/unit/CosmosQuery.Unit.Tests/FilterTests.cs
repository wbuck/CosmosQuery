...
public sealed class FilterTests
{
    ...
    [InlineData("cast(CosmosQuery.Unit.Tests.Data.SimpleEnum'First',Edm.String) eq 'First'", "$it => (First.ToString() == \"First\")")]
    [InlineData("cast(SimpleEnumProp,Edm.String) eq 'First'", "$it => ($it.SimpleEnumProp.ToString() == \"First\")")]
    ...
    [InlineData("cast(NullableSimpleEnumProp,Edm.String) eq 'First'", "$it => (IIF($it.NullableSimpleEnumProp.HasValue, $it.NullableSimpleEnumProp.Value.ToString(), null) == \"First\")")]
    [InlineData("cast(CosmosQuery.Unit.Tests.Data.SimpleEnum'1',Edm.String) eq 'Second'", "$it => (Second.ToString() == \"Second\")")]
    [InlineData("cast(StringProp,CosmosQuery.Unit.Tests.Data.SimpleEnum) eq null", "$it => (null == null)")]
    [InlineData("cast(StringProp,CosmosQuery.Unit.Tests.Data.FlagsEnum) eq null", "$it => (null == null)")]
    ...
    [InlineData("SimpleEnumProp eq @p", "CosmosQuery.Unit.Tests.Data.SimpleEnum'First'", "$it => (Convert($it.SimpleEnumProp) == 0)")]
    ...
    [InlineData("@p eq CosmosQuery.Unit.Tests.Data.SimpleEnum'First'", "SimpleEnumProp", "$it => (Convert($it.SimpleEnumProp) == 0)")]
